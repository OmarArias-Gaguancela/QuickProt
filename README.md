...
This pipeline uses data from spreadsheets generated by DIA-NN or Skyline software. Without any coding experience, users only need to create a folder in Google Drive and store the data in a spreadsheet in TSV or CSV format from DIA-NN or Skyline, respectively.
