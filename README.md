...
These pipelines use data from spreadsheets (TSV or CSV format) generated by DIA-NN or Skyline software. Without coding experience, users only need to create a folder in Google Drive and store the DIA-NN or Skyline reports.
