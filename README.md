...
These pipelines use data from spreadsheets (TSV or CSV format) generated by DIA-NN or Skyline software. 

Users only need to create a folder in Google Drive and store the DIA-NN or Skyline reports.

The outputs generated from this pipeline are automatically stored in two folders within the Google Drive folder created by the user. 
