...
This pipeline uses data from spreadsheets (TSV or CSV format) generated by DIA-NN or Skyline software. Without any coding experience, users only need to create a folder in Google Drive and store the data spreadsheet.
